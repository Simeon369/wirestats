-- Migration 00019: Update tournament_player_leaderboard view to include
-- all new stat types (reb, blk, stl, ast) and an MVP rating column.
-- Rules:
--   - Only players from finished games qualify
--   - Player must have at least 1 stat event (any type) to appear
